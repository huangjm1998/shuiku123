...
/**
 * @文件名称：SYQ_warning.java
 * @创建时间：2020-04-10 16:12:46
 * @创 建  人：曾凡宇
 * @文件描述：SYQ_warning 实体类
 * @文件版本：V0.01
 */

@Data
public class SYQ_warning {
    private Integer id;
    private String FH;
    ...
    private Long Address_station;
    private String TAG_self_inspection;
    private String Station_status_data;
...
//	}
//	public void setStation_status_data(String Station_status_data){
//	this.Station_status_data=Station_status_data;
//	}
//	public String getStation_status_data(){
