...
/**
 * @文件名称：SYQ_picture_timing.java
 * @创建时间：2020-04-10 16:02:14
 * @创 建  人：曾凡宇
 * @文件描述：SYQ_picture_timing 实体类
 * @文件版本：V0.01
 */

@Data
@Accessors(chain = true)
public class SYQ_picture_timing {
    private Integer id;
    private String FH;
...
//		return TAG_picture;
//	}
//	public void setPicture_message(String Picture_message){
//	this.Picture_message=Picture_message;
//	}
//	public String getPicture_message(){
