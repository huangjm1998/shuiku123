...
/**
 * @文件名称：SYQ_update_password.java
 * @创建时间：2020-04-10 16:11:59
 * @创 建  人：曾凡宇
 * @文件描述：SYQ_update_password 实体类
 * @文件版本：V0.01
 */

@Data
public class SYQ_update_password {
    private Integer id;
    private String FH;
...
//	}
//	public void setTAG_password(String TAG_password){
//	this.TAG_password=TAG_password;
//	}
